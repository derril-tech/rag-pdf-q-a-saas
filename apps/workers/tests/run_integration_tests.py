...
def run_integration_tests():
    ...
    # Configure pytest arguments for integration tests
    pytest_args = [
        str(test_dir),
        "-v",  # Verbose output
        ...
        "--cov-report=html:htmlcov_integration",  # Generate HTML coverage report
        "--cov-report=xml:coverage_integration.xml",  # Generate XML coverage report
        "--junit-xml=test-results_integration.xml",  # Generate JUnit XML report
